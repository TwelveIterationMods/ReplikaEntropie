...
public class ScrapSlot extends IngredientSlot {
    ...
    private final Pair<ResourceLocation, ResourceLocation> ICON = Pair.of(InventoryMenu.BLOCK_ATLAS, new ResourceLocation("replikaentropie", "item/empty_scrap_slot"));
