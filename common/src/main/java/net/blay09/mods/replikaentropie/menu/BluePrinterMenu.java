...
public class BluePrinterMenu extends AbstractContainerMenu {
    ...
    public BluePrinterMenu(int id, Inventory inventory, Container container, ContainerData data, ContainerLevelAccess access) {
        ...
        addSlot(new IngredientSlot(container, BluePrinterBlockEntity.CYAN_DYE_SLOT, 106, 25, Ingredient.of(Items.DYE.cyan()), id("container/slot/cyan_dye")) {
            @Override
        ...
        quickMove = QuickMove.create(this, this::moveItemStackTo)
                ...
                .route(it -> it.is(Items.DYE.cyan()), QuickMove.PLAYER, "cyan_dye")
