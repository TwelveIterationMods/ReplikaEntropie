...
public class ModBlockTags {
    ...
    public static final TagKey<Block> CRANE_RELOCATION_NOT_SUPPORTED = TagKey.create(Registries.BLOCK, id("crane_relocation_not_supported"));
    public static final TagKey<Block> SLASHED_BY_BIOMASS_HARVESTER = TagKey.create(Registries.BLOCK, id("slashed_by_biomass_harvester"));
}
